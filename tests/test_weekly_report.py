...
class WeeklyReportTests(unittest.TestCase):
    ...
    def test_weekly_page_contains_quality_and_model_tabs(self) -> None:
        ...
        self.assertIn('class="intersection-persistence"', page)
        self.assertIn(".intersection-persistence .inout>div>b{flex-basis:100%", page)
        self.assertIn(".intersection-persistence .weekly-chip{margin:0 3px 0 0;padding:6px 11px", page)
