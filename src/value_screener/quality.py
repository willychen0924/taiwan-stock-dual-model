...
def revenue_coverage_checks(
    ...
    *,
    ...
    metrics = revenue_coverage_metrics(rows, financial_industries=financial_industries)
    ...
    checks = [
        {
            ...
            "notes": f"以量化硬門檻通過公司為分母，需達 {threshold_label}",
        },
        {
            "check": "一般公司營收覆蓋率",
            ...
            "notes": f"以有成交且非金融業公司為分母，需達 {threshold_label}",
        },
    ]
